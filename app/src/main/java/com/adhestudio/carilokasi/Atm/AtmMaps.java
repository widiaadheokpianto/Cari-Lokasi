package com.adhestudio.carilokasi.Atm;
...
public class AtmMaps extends FragmentActivity implements LocationListener
{
    ...
    private class PlacesTask extends AsyncTask<String, Integer, String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(AtmMaps.this);
