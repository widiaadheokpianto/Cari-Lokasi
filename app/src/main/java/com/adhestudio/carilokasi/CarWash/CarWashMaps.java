package com.adhestudio.carilokasi.CarWash;
...
public class CarWashMaps extends FragmentActivity implements LocationListener
{
    ...
    private class PlacesTask extends AsyncTask<String, Integer, String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CarWashMaps.this);
